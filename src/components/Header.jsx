    ...
    return (
        <header className="sticky top-0 z-40 w-full md:border-none pointer-events-none">
            <div className="flex items-center justify-between py-6 pointer-events-auto">
                ...
                <div className="md:hidden text-xl font-bold bg-[#1a1a1a]/70 backdrop-blur-sm px-4 py-2 rounded-xl border border-[#222]">Menu</div>

                <nav className="hidden md:flex text-md font-bold items-center gap-8 mx-auto bg-[#1a1a1a]/70 backdrop-blur-sm px-8 py-4 rounded-full border border-[#222] shadow-2xl">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 rounded-full bg-[#1a1a1a]/70 backdrop-blur-sm border border-[#222] hover:bg-[#222] hover:text-white transition-all font-bold text-md"
                    >
                        {language === 'fr' ? 'EN' : 'FR'}
                    </button>

                    <a href="#contact" className="flex items-center gap-2 px-6 py-3 rounded-full bg-[#1a1a1a]/70 backdrop-blur-sm border border-[#222] hover:bg-[#e0c3fc] hover:text-black transition-all font-bold text-md">
