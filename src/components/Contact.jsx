        ...
        <Section id="contact" className="pb-10">
            <div className="bg-gradient-to-br from-[#1a1a1a] to-[#050505] rounded-[3rem] p-12 md:p-24 text-center border border-[#222] relative overflow-hidden group">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <a href={`mailto:${profile.contact.email}`} className="inline-block px-12 py-6 rounded-full font-bold text-black bg-white hover:bg-gray-200 transition-all text-xl hover:scale-105 shadow-xl">
